...
// Fri May 29 19:21:22 2020 by ROOT version 6.14/09
// from TTree tree/tree
// found on file: root://xrootd.accre.vanderbilt.edu//store/user/hats/PyRoot/2017/qcd_samples/shuffled_sig/sig_shuffled_0.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://xrootd.accre.vanderbilt.edu//store/user/hats/PyRoot/2017/qcd_samples/shuffled_sig/sig_shuffled_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://xrootd.accre.vanderbilt.edu//store/user/hats/PyRoot/2017/qcd_samples/shuffled_sig/sig_shuffled_0.root");
      }
